...
mt19937 rnd(1345678);
int N , M , A[303] , P[303][603] , TEST_CASE;
...
int main(){
	...
	random(4); random(10); random(50);
	random(200);

	seldom_change(0 , 0); seldom_change(0 , 0);
	seldom_change(0 , 1); seldom_change(0 , 1);
	seldom_change(1 , 1); seldom_change(1 , 0);
	seldom_change(2 , 5); seldom_change(2 , 5);
	seldom_change(10 , 20);
	seldom_change(10 , 0); seldom_change(10 , 0);

	choose_in_random(2 , 0); choose_in_random(2 , 0);
	choose_in_random(2 , 1); choose_in_random(2 , 1);
	choose_in_random(2 , 3);
	choose_in_random(2 , 15); choose_in_random(2 , 15);
	choose_in_random(2 , 40);
	choose_in_random(3 , 0); choose_in_random(30 , 0);
	choose_in_random(5 , 1); choose_in_random(15 , 1);
	choose_in_random(9 , 3);
	choose_in_random(15 , 15); choose_in_random(5 , 15);
	choose_in_random(30 , 40);

	slow(0); slow(1);

	vector < int > subsize{3,10,48,79,204,512};
	for(auto t : subsize){
		N = t;
		random(0); random(0);
		slow(0); slow(1);
		choose_in_random(gen(2 , 5) , rnd() % 2 ? 0 : gen(1 , 20));
		choose_in_random(gen(2 , 5) , rnd() % 2 ? 0 : gen(1 , 20));
		seldom_change(gen(1 , 8) , rnd() % 2 ? 0 : gen(1 , 20));
		seldom_change(gen(1 , 8) , rnd() % 2 ? 0 : gen(1 , 20));
	}
	return 0;
}